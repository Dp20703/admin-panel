                        ...
                        <div className="x_panel">
                            ...
                            <div className="x_content">
                                {feedbacks.length === 0 ? (
                                    ...
                                    feedbacks.map((feedback) => (
                                        <div key={feedback.id} className="well d-flex align-items-center">
                                            {/* User Image */}
                                            ...
                                            <div className="flex-grow-1">
                                                <h4>{feedback.name} <small>({feedback.role})</small></h4>
            ...
            {selectedProfile && (
                <div className="modal-overlay">
                    <div className="modal-content px-5 py-3">
                        ...
                        <button className="btn btn-secondary" onClick={() => setSelectedProfile(null)}>
                            Close
                        </button>
                    </div>
                </div>
