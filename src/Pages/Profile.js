                            ...
                            <div className="col-md-3 col-sm-3 profile_left text-center">
                                ...
                                {isEditing ? (
                                    <>
                                        ...
                                        <button className="btn btn-secondary mt-2" onClick={handleEditToggle}>
                                            Cancel
                                        </button>
                                    </>
                                ) : (
                                    <>
                                        ...
                                        <ul className="list-unstyled user_data">
                                            <li>
                                                <i className="fa fa-map-marker user-profile-icon" /> {profile.location}
                                            </li>
                                            <li>
                                                <i className="fa fa-briefcase user-profile-icon" /> {profile.role}
                                            </li>
                            ...
                            <div className="col-md-9 col-sm-9">
                                ...
                                <div role="tabpanel">
                                    <ul className="messages">
                                        {[
                                            { name: "Desmond Davison", date: "24", month: "May", message: "Raw denim you probably haven't heard of them jean shorts Austin." },
                                            { name: "Brian Michaels", date: "21", month: "May", message: "Nesciunt tofu stumptown aliqua butcher retro keffiyeh dreamcatcher." },
                                            { name: "Desmond Davison", date: "24", month: "May", message: "Raw denim you probably haven't heard of them jean shorts Austin." },
                                            { name: "Brian Michaels", date: "21", month: "May", message: "Nesciunt tofu stumptown aliqua butcher retro keffiyeh dreamcatcher." },
                                        ].map((activity, index) => (
                                            <li key={index} className="d-flex align-items-center">
                                                ...
                                                <div className="message_date text-center">
                                                    <h3 className="date text-info mb-0">{activity.date}</h3>
                                                    <p className="month">{activity.month}</p>
                                                </div>
                                                <div className="message_wrapper ms-3">
                                                    <h4 className="heading">{activity.name}</h4>
                                                    <blockquote className="message">{activity.message}</blockquote>
                                                </div>
                                            </li>
                                        ))}
                                    </ul>
