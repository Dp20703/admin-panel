    ...
    const initialProperties = [
        {
            ...
            progress: 27,
            status: "Pending",
            owner: { name: "John Doe", avatar: "images/user.png", contact: "+91 9054800900" },
        },
        {
            id: "A002",
            ...
            progress: 85,
            status: "For Rent",
            owner: { name: "Jane Smith", avatar: "images/user.png", contact: "+91 9054800900" },
        },
    ];
                                            ...
                                            {filteredProperties.map((property, index) => (
                                                <tr key={property.id}>
                                                    ...
                                                    <td>
                                                        <span
                                                            className={`badge ${
                                                                property.status === "Pending" ? "bg-danger" : "bg-success"
                                                            }`}
                                                        >
                                                            {property.status}
                                                        </span>
                                                    ...
                                                    <td>
                                                        <button className="btn btn-xs btn-primary m-1" onClick={() => handleView(property)}>
                                                            <i className="fa fa-eye" /> View
                                                        </button>
                                                        <button className="btn btn-xs btn-danger m-1" onClick={() => handleDelete(property.id)}>
