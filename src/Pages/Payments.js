                        ...
                        <div className="title_right">
                            <div className="col-md-5 col-sm-5 form-group pull-right top_search">
                                <div className="d-flex flex-column justify-content-center">
                                    <label className="ml-2" htmlFor="search-payment">Search by</label>
                                    <input
                                        id="search-payment"
                                        type="text"
                                        className="form-control" style={{ fontSize: '15px' }}
                ...
                {selectedPayment && (
                    <div className="modal-overlay" style={{ marginBottom: "70px" }}>
                        <div className="modal-content px-5 py-3">
                            ...
                            <p><strong>User:</strong> {selectedPayment.user} ({selectedPayment.userId})</p>
                            <p><strong>Property:</strong> {selectedPayment.property} ({selectedPayment.propertyId})</p>
                            <p><strong>Owner:</strong> {selectedPayment.owner} ({selectedPayment.ownerId})</p>
